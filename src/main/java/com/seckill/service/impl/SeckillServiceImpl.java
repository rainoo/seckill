...
public class SeckillServiceImpl implements ISeckillService {
	...
	private final String salt = "sdf32k6as78g9hTI0ksd-fT&873j%";
	 ...
	 * 2：保证事务方法的执行时间尽可能短，不要穿插其他的网络操作RPC/HTTP请求，或者剥离到事务方法外部。
